...
#define OPENLTTO_UI_LCD_H_RES              (320)
#define OPENLTTO_UI_LCD_V_RES              (240)
#define OPENLTTO_UI_LCD_PIXEL_CLOCK_HZ     (40 * 1000 * 1000)
#define OPENLTTO_UI_LCD_SPI_NUM            (2)
...
#define OPENLTTO_UI_LCD_DATA0         (37)
#define OPENLTTO_UI_LCD_PCLK          (36)
#define OPENLTTO_UI_LCD_CS            (3)
#define OPENLTTO_UI_LCD_DC            (35)
#define OPENLTTO_UI_LCD_RST           (-1)
#define OPENLTTO_UI_LCD_BACKLIGHT     (-1)
#define OPENLTTO_UI_LCD_TOUCH_INT     (9)
